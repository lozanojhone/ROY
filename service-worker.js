const CACHE='roy-enterprise-4-5-stable-performance';
const CORE=[
  ...
  './js/17-user-security-audit-v4.1.js','./js/20-account-security-v4.9.js','./js/21-owner-controls-refinements-v4.2.js','./js/22-critical-fixes-v4.3.js','./js/23-pwa-install-v4.4.js','./js/24-stability-performance-v4.5.js',
