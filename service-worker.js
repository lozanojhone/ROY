const CACHE='roy-enterprise-4-3-realtime-catalog-final';
const CORE=[
  ...
  './css/form-controls-v3.3.css','./css/navigation-builder-v4.0.css','./css/user-security-v4.1.css',
  ...
  './js/17-user-security-audit-v4.1.js','./js/18-realtime-catalog-v4.3.js',
  './assets/logo-roy-verde-blanco.png','./assets/logo/roy-logo.png'
];
