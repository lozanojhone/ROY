const CACHE='roy-v5.0-product-gallery';
const CORE=[
  ...
  './js/17-user-security-audit-v4.1.js','./js/18-realtime-catalog-v4.3.js','./js/20-account-security-v4.9.js','./js/21-product-gallery-v5.0.js',
