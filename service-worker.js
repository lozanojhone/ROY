const CACHE='roy-v5.2-original-images-only';
const CORE=[
  ...
  './css/form-controls-v3.3.css','./css/navigation-builder-v4.0.css','./css/user-security-v4.1.css','./css/account-security-v4.9.css','./css/product-gallery-v5.0.css',
  ...
  './js/17-user-security-audit-v4.1.js','./js/18-realtime-catalog-v4.3.js','./js/20-account-security-v4.9.js','./js/21-product-gallery-v5.0.js','./js/22-hotfix-v5.1.js',
