const CACHE='roy-luxury-5-1-gold-final';
const CORE=[
  './','./index.html','./admin.html','./offline.html','./manifest.webmanifest',
  './css/app.css','./css/luxury-final-v5.1.css','./css/payment-admin-v3.1.css','./css/payment-checkout-v3.2.css',
  ...
  './js/17-user-security-audit-v4.1.js','./js/20-account-security-v4.9.js','./js/21-owner-controls-refinements-v4.2.js','./js/22-critical-fixes-v4.3.js','./js/23-pwa-install-v4.4.js','./js/24-stability-performance-v4.5.js','./js/25-users-freeze-hotfix-v4.6.js','./js/26-luxury-brand-migration-v5.1.js',
