const CACHE='roy-enterprise-3-1';
const CORE=['./','./index.html','./admin.html','./css/app.css','./css/payment-admin-v3.1.css','./js/14-payments-qr-v3.1.js',
  './css/roy-hotfix-2.6.css','./offline.html','./manifest.webmanifest','./assets/logo-roy-verde-blanco.png','./assets/logo/roy-logo.png'];
