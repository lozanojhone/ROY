...
import {getFirestore,collection,getDocs,addDoc,setDoc,updateDoc,deleteDoc,doc,getDoc,serverTimestamp,writeBatch} from 'https://www.gstatic.com/firebasejs/12.16.0/firebase-firestore.js';
...
try{
 ...
 Object.assign(window,{_db:db,_storage:storage,_auth:auth,_firebaseConfig:firebaseConfig,_firebaseInitializeApp:initializeApp,_firebaseDeleteApp:deleteApp,_firebaseGetAuth:getAuth,_fb:{collection,getDocs,addDoc,setDoc,updateDoc,deleteDoc,doc,getDoc,serverTimestamp,writeBatch,ref,uploadBytes,uploadBytesResumable,getDownloadURL,signInWithEmailAndPassword,createUserWithEmailAndPassword,signOut,onAuthStateChanged,sendPasswordResetEmail},_firebaseReady:true,_firebaseAdmin:false,_firebaseRole:null,_firebasePermissions:[],_firebaseUser:null});
