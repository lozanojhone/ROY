...
(function(){
 ...
 async function compress(file){
  ...
  const data=await make(1600,.88,620000);
  const thumbData=await make(600,.84,150000);
  bmp.close?.();
  if(data.length>=900000)throw new Error('La imagen supera el límite seguro. Usa una fotografía de menor resolución o peso.');
