...
(function(){
 ...
 function canView(view){const p=window._firebasePermissions||[];const permission=view==='upcoming'||view==='sale-content'?'gallery':view;return p.includes('*')||p.includes(permission)}
